...
def decode(message):
    ...
    # reverse alphabet string
    rev_alpha = "zyxwvutsrqponmlkjihgfedcba"

    # create translation table for corresponding values using maketrans
    translation_table = str.maketrans(rev_alpha, alpha)

    # use translate to decode the message
